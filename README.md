...
- Now you can upload a test file of reviews and then it will show you the graph of the predicted sentiments. Check it out [here](https://arnav-sentiment-analysis.herokuapp.com/upload)
